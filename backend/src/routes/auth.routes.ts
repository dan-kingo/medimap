...
import { forgotPasswordRequestOtp, loginWithPassword, requestOtp, resendOtp, setPassword, verifyForgotPasswordOtp, verifyOtpAndSetPassword } from '../controllers/auth.controller.js';
